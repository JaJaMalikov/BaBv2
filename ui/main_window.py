...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        for dock in (self.timeline_dock, self.inspector_dock, self.library_dock):
            dock.visibilityChanged.connect(self.ensure_fit)
            dock.topLevelChanged.connect(self.ensure_fit)
        self.ensure_fit()
