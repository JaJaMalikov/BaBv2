...
class ObjectViewAdapterProtocol(Protocol):
    ...
    # Creation flows
    def create_object_from_file(self, file_path: str, scene_pos: Optional[Any] = None) -> Optional[Tuple[Any, Dict[str, Any]]]: ...
    def create_light_object(self, scene_pos: Optional[Any] = None) -> Optional[Tuple[Any, Dict[str, Any]]]: ...
